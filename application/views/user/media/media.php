<div class="container d-flex align-content-center flex-wrap">
    ...
    <section class="hero">
        ...
        <div class="col-xl-10 mx-auto">
            ...
            <h1 class="text-center mt-4 mb-4" itemprop="name">Media</h1><!--inject category title-->
                    ...
                    <div class="navbar navbar-expand-lg navbar-light">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                <?php for($i = 0; sizeOf($data_mc) > $i; $i++) echo ('<li class="nav-item"><a class="nav-item nav-link" href="/user/media_category/'.$data_mc[$i]->media_category_id.'" data-filter="'.$data_mc[$i]->media_category_title.'"'.">".$data_mc[$i]->media_category_title.'</a></li>');?>
                            </ul>
                        </div>
                </div>
                </div>
            ...
            <?php
                $totalpages = ceil($media_count / 5);
                $currentActiveP = $this->uri->segment(3);
                $currentActiveN = $this->uri->segment(3);
                ...
                if($totalpages > 1) {
                    echo ' <div class="row">
                            ...
                            <nav id="media_pagination">
                                <ul class="pagination justify-content-end">
                                    <li class="page-item">
                                        <a class="page-link" href="/user/media/'.$currentActiveP.'" aria-label="Previous">
                    ...
                    for($i = 0; $totalpages > $i; $i++) {
                        echo '<li class="page-item"><a class="page-link" href="/user/media/'.($i+1).'">'.($i+1).'</a></li>';
                    }           
                                    
                                echo '
                                    <li class="page-item">
                                        <a class="page-link" href="/user/media/'.$currentActiveN.'" aria-label="Next">
                                            <span aria-hidden="true">»</span>
