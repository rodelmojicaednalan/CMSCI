                    ...
                    <div class="col-10">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <p>
                                Use this page to add a Document Category for your Documents. To Manage your Document categories use the <a href="/admin/docs_manage_categories" title="Manage Document Categories">Manage Document Categories</a> page. You will need to click the Save button to save your changes.
                              </p>
                  ...
                  <div class="row">
                    <div class="col-10 mb-3 text-right">
                      <div class="button-list">
                        <a href="/admin/content_document" class="btn btn-outline-warning" title="Manage Document">Manage Documents</a>
                  ...
                  <div class="row">
                      <div class="col-10">
                          <div class="card">
                            ...
                            <?php echo form_open('#', array('id' => 'frm_new_doccat')) ?>
                              <div class="form-group mb-3">
                                  ...
                                  <input type="text" id="docscat-input" name="document_category_title" class="form-control" placeholder="Document Category Title Here" required>
                              </div>
                                <div class="form-group mb-3"><!--Please add a Froala Editor here-->
                                        ...
                                        <textarea class="form-control" name="document_category_description" id="docscat-textarea" rows="3" placeholder="Enter the Document item description."></textarea>
                                    </div>
                            </div> <!--end card body-->
                          </div> <!--end card-->
                        </div><!--end col-->
                            ...
                            <div class="card-body">
                              <span class="form-group mb-2">
                                  ...
                                  <select class="form-control" id="reviewauthor-select" name="document_category_parent">
                                      <option class="selected" value="">None</option>
                                      <?php foreach($doc_categoryobj as $doc_cat): ?>
                                            <option value="<?= $doc_cat->document_category_id ?>"><?= $doc_cat->document_category_title ?></option>
                                      <?php endforeach; ?>
                                  </select>
                                </span>
                            </div>
                            ...
                            <div class="card">
                              <div class="card-body">
                                    <span class="form-group pb-3">
                                            ...
                                            <input type="text" id="custom-caturl-input" name="document_category_customurl" class="form-control" placeholder="https://">
                                        </span>
                              </div>
                            </div>
                        </div>
