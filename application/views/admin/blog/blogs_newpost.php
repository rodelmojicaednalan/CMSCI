                ...
                <div class="container-fluid">
                  ...
                  <?php echo form_open_multipart('/admin/preview_unsavepost', array('id' => 'frm_blog_post')); ?>
                  <div class="row">
                        <div class="col-10 mb-3">
                                ...
                                <div class="text-right">
                                    <button onclick="window.location='/admin/content_blogs'" type="button" class="btn btn-lg btn-secondary" id="cancel">Cancel</button>
                                      ...
                                      <button type="button" id="preview_unsavepost" class="btn btn-lg btn-info">Preview</button>
                                      <button type="button" id="add_draft_post"   class="btn btn-lg btn-success">Save Draft</button>
                                      <button type="button" id="add_publish_post" class="btn btn-lg btn-primary">Publish</button>
                                  </div>
                                </div>
                            </div>
              </div><!--end row-->
                          ...
                          <div class="card">
                            <div class="card-body">
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input type="text" id="posttitle-input" name="post_title" class="form-control" placeholder="Enter a Title Here" required>
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input type="text" id="blogtitle-input" name="custom_post_url" class="form-control" placeholder="https://yoursite.com/blog/blogpost">
                              </div>
                              <h2 class="header-title mb-3">
                               Post Description Text&nbsp;<a href="#" data-toggle="tooltip" title="" data-original-title="Enter in a description for your blog post. This information will be displayed on your page under the first image and under the post title. Since this is the first piece of content in your blog post, this is what search engines will crawl first to determine if your content should be displayed in search results for this subject. This description will also be used by Google to determine the page ranking. There is no length limit, but for best results, be concise and choose a lead with a hook."><i class="dripicons mdi mdi-help-circle-outline"></i></a>
                                ...
                                <textarea id="froala-editor" name="post_description" class="post_description"  required><!-- post description-->
                              ...
                              <span class="form-group mb-3">
                                  ...
                                  <select class="form-control" name="post_author" id="author-select">
                                        <?php foreach($blogAuthors as $blog_author): ?>
                                            <option value="<?= $blog_author->user_id ?>"><?= $blog_author->user_name ?></option>
                                        <?php endforeach; ?>
                                  </select>
                                </span>
                            </div>
                                  ...
                                  <select class="form-control" id="permissions-select" name="post_permission">
                                      <option value="0">Everyone</option><!--this should be the default if they do not make a choice-->
                                        <?php foreach($group_members as $group_member): ?>
                                            <option value="<?= $group_member->groups_id ?>"><?= $group_member->groups_name ?></option>
                                        <?php endforeach; ?>
                                  </select>
                              </span>
                            </div>
                                ...
                                <span class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="category-select" name="post_blog_category">
                                        <?php foreach($blogCategories as $blog_category): ?>
                                            <option value="<?= $blog_category->blog_category_id ?>"><?= $blog_category->blog_category_title ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                  </span>
                                  <h4 class="header-title mt-3">Click Below to Add or Manage your categories</h4>
                                  <span class="button-list">
                                      <a href="/admin/blog_manage_categories" class="btn btn-primary" title="Manage Categories">Manage Categories</a>
                                  </span>
                              </div>
                            </div>
                        </div>
                            ...
                            <div class="card pb-2">
                              <div class="card-body">
                                <span class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" id="keyword-textarea" name="post_keyword" rows="5" placeholder="keyword 1, keyword 2, keyword 3"></textarea>
                                </span>
                              </div>
                            </div>
                          </div><!--end cards-->
                              ...
                              <div class="card-body">
                                <span class="form-group">
                                      ...
                                      <div class="text-center border p-3 mb-3  dropzone"><!--this is number 1 of potentially 3 images-->
                                           <!--<form action="#" method="post" class="dropzone" id="image1Dropzones" data-plugin="dropzone" data-previews-container="#file-previews1"
                                              data-upload-preview-template="#uploadPreviewTemplate">  -->
                                              
                                              <div class="fallback">
                                                  <input name="post_image1" id="post_image1" type="file" required /> 
                                              </div>
                                      ...
                                      <!--end dropzone-->
                                      <div class="text-center dz-delete-preview0">
                                        <button type="button" class="btn btn-danger btn-icon btn-rounded" value="submit"><i class="mdi mdi-delete"></i>&nbsp;Delete Image</button> 
                                      </div>
                                  </span>
                                  <span class="form-group mb-3">
                                        ...
                                        <input type="text" id="image1caption-input" name="post_image1_caption" class="form-control" placeholder="Optional Image Caption">
                                  </span>
                              </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                              <div class="card-body pb-8">
                                <span class="form-group">
                                  ...
                                  <!--PHP HERE-->
                                  <textarea class="form-control mb-3" name="post_meta" id="meta-textarea" rows="10" placeholder="Your description should be no more than 120 to 158 characters. This description will not be visible on the page." required></textarea>
                                </span>
                                  ...
                                  <div class="card-body">
                                      <span class="form-group">
                                        ...
                                        <h2 class="header-title mb-3">
                                               ...
                                               <textarea id="froala-editor" name="post_article1"></textarea>  <!--content above needs to be added to blog page - this is the first part of the blog post content.-->
                                        </span>
                                  </div><!--end card body-->
                              </div><!--end card-->
                          </div><!--end col-->
                            ...
                            <div class="card">
                              <div class="card-body">
                                <span class="form-group"><!--Please adjust this so that the image uploader will work this is only a placeholder-->
                                    ...
                                    <div class="text-center dz-delete-preview1">
                                      <button type="button" class="btn btn-danger btn-icon btn-rounded" value="submit"><i class="mdi mdi-delete"></i>&nbsp;Delete Image</button> 
                                    </div>
                                  </span>
                                  <span class="form-group mb-3">
                                        ...
                                        <input type="text" id="image2caption-input" name="post_image2_caption" class="form-control mb-3" placeholder="Optional Image 2 Caption">
                                  </span>
                              </div>
                            </div>
                        </div>
                              ...
                              <div class="card-body pb-3">
                                <span class="form-group mb-3">
                                  ...
                                  <div class="mb-3" ><!--This is Post Large Blockquote-->
                                        <textarea id="froala-editor" name="post_blockquote1"></textarea>
                                    </div>
                                 ...
                                 <span class="form-group">
                                        ...
                                        <input type="text" id="blockquote-author-input"  name="post_blockquote_author1" class="form-control mb-2" placeholder="Optional Blockquote Author here.">
                                  </span>
                                  <span class="form-group mb-3">
                                        ...
                                        <input type="text" id="blockquote-cite-input"  name="post_blockquote_publication1"  class="form-control" placeholder="Optional publication or source.">
                                  </span>
                              </div>
                            </div>
                          </div><!--end cards-->
                              ...
                              <div class="card">
                                  <div class="card-body">
                                        <span class="form-group">
                                                ...
                                                <input type="text" id="header2-input"  name="post_header2"  class="form-control  mb-3" placeholder="Optional Header 2">
                                          </span>
                                          <span class="form-group mb-3">
                                                ...
                                                <div class="mb-3"><!--This is Post Content Blockquote #1-->
                                                        <textarea id="froala-editor" name="post_article2"></textarea>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        <span class="form-group">
                                                ...
                                                <!--This is Post Header 2 - Should be a h2 on the page -->
                                                <input type="text" id="header3-input" name="post_header3" class="form-control  mb-3" placeholder="Optional Header 2">
                                          </span>
                                    <span class="form-group">
                                      <!--PUT A FROALA EDITOR HERE FOR TEXT ENTRY--><!--Please add the code so that the Froala editor can add H styling, links and images here. The full Froala code has not been added.-->
                                      <h2 class="header-title mb-3">
                                             ...
                                             <textarea id="froala-editor" name="post_article3"></textarea>   <!--content above needs to be added to blog page - this is the first part of the blog post content.-->
                                      </span>
                                </div><!--end card body-->
                            </div><!--end card-->
                        </div><!--end col-->
                            ...
                            <div class="card">
                              <div class="card-body">
                                <span class="form-group"><!--Please adjust this so that the image uploader will work this is only a placeholder-->
                                  ...
                                  <div class="text-center dz-delete-preview2">
                                    <button type="button" class="btn btn-danger btn-icon btn-rounded" value="submit"><i class="mdi mdi-delete"></i>&nbsp;Delete Image</button> 
                                  </div>
                                  </span>
                                  <span class="form-group mb-3"><!--Image 3 Caption-->
                                        ...
                                        <input type="text" id="image3caption-input" name="post_image3_caption" class="form-control mb-3" placeholder="Optional Image 2 Caption">
                                  </span>
                              </div>
                            </div>
                        </div>
                                ...
                                <span class="form-group mb-3">
                                  ...
                                  <!--add the full Froala edito here it should have image links and styling added HERE-->
                                        <div class="mb-3" ><!--This is Post SmallBlockquote-->
                                                    <textarea id="froala-editor" name="post_blockquote2"></textarea>
                                        </div>
                                </span>
                                 <span class="form-group">
                                        ...
                                        <!--This is Post Blockquote Large Author - Should be in blockquote-footer Author -->
                                        <input type="text" id="blockquotesm-author-input" name="post_blockquote_author2" class="form-control mb-2" placeholder="Optional Blockquote Author here.">
                                  </span>
                                  <span class="form-group mb-3">
                                        ...
                                        <!--This is Post Blockquote Large Publication - CITE - Should be in blockquote-footer Publication -->
                                        <input type="text" id="blockquotesm-cite-input" name="post_blockquote_publication2" class="form-control" placeholder="Optional publication or source.">
                                  </span>
                              </div>
                            </div>
                          </div><!--end cards-->
                                ...
                                <span class="form-group"><!--Please adjust this so that the image uploader will work this is only a placeholder-->
                                      ...
                                      <p>
                                            <div class="mb-3" ><!--This is Video Embed Code-->
                                                    <textarea id="froala-editor" name="post_article5">Add your optional video embed code here</textarea>
                                  ...
                                  <span class="form-group"><!--Image 3 Caption-->
                                        ...
                                        <input type="text" id="videocaption-input" name="post_header5" class="form-control mb-3" placeholder="Optional Video Caption">
                                  </span>
                              </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                              <div class="card-body">
                                    <span class="form-group">
                                            ...
                                            <!--This is Post Blockquote Large Author - Should be in blockquote-footer Author -->
                                            <input type="text" name="post_header4" id="header4-input" class="form-control mb-4" placeholder="Optional Blockquote Author here.">
                                      </span>
                                ...
                                <span class="form-group mb-6">
                                  ...
                                  <!--add the full Froala edito here it should have image links and styling added HERE-->
                                          <div class="mb-3" ><!--This is Post SmallBlockquote-->
                                                  <textarea id="froala-editor" name="post_article4"></textarea>
                                          </div>
                                </span>
                                <input type="hidden"  id="add_save_type">
                              </div>
                            </div>
                          </div><!--end cards-->
                  </div><!--end row-->
