...
class Sitedesignmodel extends CI_Model
{
	//the table associated with the user model
	private $table_name = 'site_design';
	private $primary_key = 'site_design_id';
	...
	function get($options = array())
	{
		...
		// Qualification
		if(isset($options['id'])){
			$this->db->where('site_design.site_design_id', $options['id']);
		}
