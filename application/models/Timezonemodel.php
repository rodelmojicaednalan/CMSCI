 ...
 * Timezonemodel
 *
 * @package Timezonemodel
 */

class Timezonemodel extends CI_Model
{
	//the table associated with the user model
	private $table_name = 'timezone';
	private $primary_key = 'timezone_id';
	...
	function get($options = array())
	{
		...
		// Qualification
		if(isset($options['timezone_id'])){
			$this->db->where('timezone.timezone_id', $options['timezone_id']);
		}
