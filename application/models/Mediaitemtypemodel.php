...
class Mediaitemtypemodel extends CI_Model
{
	//the table associated with the user model
	private $table_name = 'media_itemtype';
	private $primary_key = 'media_itemtype_id';
	...
	{
		$rs = $this->db->get_where( $this->table_name, [ 'media_itemtype_id' => $id ] );
