 ...
 * Fileuploadmodel
 *
 * @package Fileuploadmodel
 */

class Fileuploadmodel extends CI_Model
{

    //the table associated with the file_upload model
	private $table_name = 'file_upload';
	
	private $primary_key = 'file_upload_id';
	//the required column/values for the file_upload
	private $required_columns = array();

	//the default column/values for the file_upload
	...
	{
		if(isset($options['file_upload_id']))
			$this->db->where('file_upload.file_upload_id', $options['file_upload_id']);
		// limit / offset
	...
	{
		$this->db->where('file_upload_name', $image_name);
