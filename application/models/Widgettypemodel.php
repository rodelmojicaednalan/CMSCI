 ...
 * Widgettypemodel
 *
 * @package Widgettypemodel
 */

class Widgettypemodel extends CI_Model
{
	//the table associated with the user model
	private $table_name = 'widget_type';
	private $primary_key = 'widget_type_id';
	...
	function get($options = array())
	{
		...
		// Qualification
		if(isset($options['id'])){
			$this->db->where('widget_type.widget_type_id', $options['id']);
		}
