...
class Navigationcategorymodel extends CI_Model
{
	//the table associated with the user model
	private $table_name = 'nav_category';
	private $primary_key = 'nav_category_id';
	...
	function get($options = array())
	{
		// Qualification
		if(isset($options['id'])){
			$this->db->where('nav_category.nav_category_id', $options['id']);
		}
