 ...
 * Groupsettingsmodel
 *
 * @package Groupsettingsmodel
 */

class Groupsettingsmodel extends CI_Model
{
	//the table associated with the user model
	private $table_name = 'group_settings';
	private $primary_key = '';
	...
	function get($options = array())
	{
		...
		// Qualification
		if(isset($options['id'])){
			$this->db->where('group_settings.group_settings_id', $options['id']);
		}
