 ...
 * Userfunctionmodel
 *
 * @package Userfunctionmodel
 */

class Userfunctionmodel extends CI_Model
{

    //the table associated with the Userfunction model
	private $table_name = 'user_function';
	
	private $primary_key = 'user_function_id';
	//the required column/values for the Userfunction
	private $required_columns = array();

	//the default column/values for the Userfunction
